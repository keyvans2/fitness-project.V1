        ...
        <transition name="fade" mode="out-in">
            <div class="toggleMenu" v-if="toggle">
                ...
                <ul class="menu p-5" dir="rtl">
                    ...
                    <li class="ms " v-for="(title , i) in mobileMenu"
                        @click="activeAcardeon(title)"
                        :key="i">
                        <i class="fas fa-chevron-up float-left mt-2 text-light" v-if="current===title.id"></i>

                        <i class="fas fa-chevron-down float-left mt-2 text-light" v-else></i>
                        <a class="pb-3">
                            {{title.title}}
                            <second-lay-mobile :class="[{'activate':current===title.id}]"
                                               class="secondLm"/>
                        </a>
                    </li>
